...
export default function Edit({ rule, factsGrouped }: { rule: any, factsGrouped: Record<string, any[]> }) {
    const { data, setData, put, processing, errors } = useForm<{
        ...
        output_description: rule.output_description || '',
        fact_ids: rule.attached_fact_ids || [], // Pre-populated from controller
    });

    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/rules/${rule.id}`);
    };
